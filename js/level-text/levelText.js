...
export const levelText = [
    {
        textContent:
            new TextLines(
                ...
                /* 5 */ new Line({ text: "So, are you ready to paint?", tooltipText: [`"Sure am!" (Do Tutorial)`, `"Maybe not..." (Skip Tutorial)`], charAnimAfter: "question" }),
                ...
                /* 12 */ new Line({ text: "Well now, if you still feel like it, I was after a wall covered completely in that red paint...", waitForInput: true, inputEvent: "wallPaintedRed", tooltipText: [`"Fine, here's your red wall!"`, `"Na mate, I'm out!" (Skip tutorial level)`], charAnim: "shame", charAnimAfter: "question" }),
                ...
                /* 15 */ new Line({ text: "Well, I'll see you tomorrow I suppose! (Press fast forward to go to the next level)" })
                        ],
